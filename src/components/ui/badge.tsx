  ...
  "inline-flex items-center justify-center rounded-full border px-3 py-1 text-xs font-semibold w-fit whitespace-nowrap shrink-0 [&>svg]:size-3 gap-1.5 [&>svg]:pointer-events-none focus-visible:border-ring focus-visible:ring-ring/50 focus-visible:ring-[3px] aria-invalid:ring-destructive/20 dark:aria-invalid:ring-destructive/40 aria-invalid:border-destructive transition-all duration-200 overflow-hidden",
  {
    variants: {
      variant: {
        ...
        outline:
          "border-2 border-primary/30 text-primary bg-primary/5 [a&]:hover:bg-primary/10",
        coral:
          "border-transparent bg-[var(--coral-pop)] text-white shadow-sm",
        mint:
          "border-transparent bg-[var(--mint-fresh)] text-white shadow-sm",
        sunshine:
          "border-transparent bg-[var(--sunshine-yellow)] text-[var(--foreground)] shadow-sm",
        purple:
          "border-transparent bg-[var(--purple-energy)] text-white shadow-sm",
      },
    },
    defaultVariants: {
      variant: "default",
